...
<head>
    ...
    <link rel="stylesheet" href="style/profile-index-style.css">
</head>
<body>
    <main>
        <div class="profile">
            ...
            <div class="d-flex form-row">
                <div class="d-flex-column">
                        ...
                        if(isset($_POST['submit'])){
                            if(isset($_POST['nama'])){
                                ...
                                if(preg_match($regex_nama, $nama))
                                    echo "<span class='validation-success'>&#x2713; Nama Valid</span>";
                                else
                                    echo "<span class='validation-failed'>X Nama TIDAK Valid</span>";
                            }
                        }
                    ?>
                                ...
                                if(isset($_POST['submit'])){
                                    if(isset($_POST['nrp'])){
                                        ...
                                        if(preg_match($regex_nrp, $nrp))
                                            echo "<span class='validation-success'>&#x2713; NRP Valid</span>";
                                        else
                                            echo "<span class='validation-failed'>X NRP TIDAK Valid</span>";
                                    }
                                }
                            ?>
                        </div>
                    ...
                    <div class="d-flex">
                        ...
                        <input type="text" name="tanggal-lahir" value="<?php if(isset($_POST['tanggal-lahir'])) echo $_POST['tanggal-lahir']; ?>">
                    </div>
                        ...
                        if(isset($_POST['submit'])){
                            if(isset($_POST['tanggal-lahir'])){
                                ...
                                if(preg_match($regex_tgl_lahir, $tgl_lahir))
                                    echo "<span class='validation-success'>&#x2713; Tanggal Lahir Valid</span>";
                                else
                                    echo "<span class='validation-failed'>X Tanggal Lahir TIDAK Valid</span>";
                            }
                        }
                    ?>
